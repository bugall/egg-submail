...
function Message(options) {
    this.appid = options.messageConfig.appid;
    this.signtype = options.messageConfig.signtype;
    this.appkey = options.messageConfig.appkey;
    this.xsend_uri = options.messageConfig.xsend_uri;
    this.send_uri = options.messageConfig.send_uri;
    this.multiXsend_uri = options.messageConfig.multiXsend_uri;
    this.subscribe_uri = options.messageConfig.subscribe_uri;
    this.unsubscribe_uri = options.messageConfig.unsubscribe_uri;
    this.template_uri = options.messageConfig.template_uri;
    this.timestamp_uri = 'https://api.mysubmail.com/service/timestamp.json'
    ...
    this.xsend = function(params) {
        ...
        request({
            ...
            console.log(params, '####3', requestParams)
            request.post({url: api, formData: requestParams}, function optionalCallback(err, httpResponse, body) {
                if (err) {
                    return console.error(err);
                }
